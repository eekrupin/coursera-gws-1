...
//go test -bench BenchmarkFast -benchmem -cpuprofile=cpu.out -memprofile=mem.out -memprofilerate=1
//go test -bench BenchmarkFast main_test.go

//easyjson.go -all fast.go
